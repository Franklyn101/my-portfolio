                        ...
                        <transition name="fade" mode="out-in">
                            <div v-if="currentTab === 1" class="dark:text-slate-200 tracking-wide">
                                <div class="prose dark:prose-invert prose-teal tracking-wide mb-7 text-left md:text-justify">
                                    <p>Hi, This is <strong>Franklyn inoma</strong></p>
                                    <p>  about <strong>Software Development</strong> & <strong>Programming</strong> in general. I am a Frontend Web Developer For the past <strong>one year</strong> I have worked with multiple clients in various project based work. Currently working with <a target="_blank" href="https://shopbot.africa"></a> as a Web Developer Intern.</p>
                                    <p>I am always open to learning new technologies and build new things that will shape the business of my clients.</p>
                                </div>

                                <a href="https://docs.google.com/document/d/1b3Ah3Rlx7_cQUpLbvjA2jEnf3Mb1W68N/edit" target="_blank" class="text-primary-500 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 font-medium flex items-center justify-start w-fit transition-all duration-300">
                            ...
                            <div v-else-if="currentTab === 3" class="dark:text-slate-200 tracking-wide">
                                <Experience designation="Web Developer intern" company="shopbotafrica" timeline="october 2023 - Present">
                                    <template #description>
                                        <ul>
                                            <li>Develop web applications using Vue.js,Angular,</li>
