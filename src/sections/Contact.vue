...
const api = 'https/franklyn/api/v1/messages';
                    ...
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p><a href="franklyninoma@gmail.com" class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">franklyninoma@gmail.com</a></p>
                            </div>
                        </li>
                        <li class="flex items-center space-x-4">
                            <div>
                            ...
                            <div>
                                ...
                                <ul class="flex items-center space-x-2">
                                    <li>
                                        <a href="https://www.facebook.com/ayebakuro.franklyninoma/" target="_blank">
                                    ...
                                    <li>
                                        <a href="https://www.linkedin.com/in/franklyninoma/" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" class="fill-current transition-all duration-300 hover:fill-secondary-500 dark:hover:fill-secondary-400">
                                    ...
                                    <li>
                                        <a href="https://x.com/fiphenomenal/" target="_blank">
                        ...
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p><a href="" target="_blank" class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">Nigeria</a></p>
                            </div>
                        </li>
                    </ul>
                </div>
